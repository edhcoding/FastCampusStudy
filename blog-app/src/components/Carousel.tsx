      ...
      <div className="carousel">
        <ul className="carousel__slides">
          <input
            ...
            name="radio-buttons"
            id="img-1"
            checked={activeImage === 1} // checked 속성은(boolean 속성) 페이지가 로드될 때 미리 선택될 input 요소를 명시함 (type이 checkbox or radio 일 때만 사용 가능한 속성 임)
            readOnly // 값 변경 불가 읽기만 가능, 보통 value 속성이랑 같이 사용함
          />
