 ...
 *
 * GoDaddy란?
 * - GoDaddy: 미국의 대표적인 도메인 등록 업체 및 웹 호스팅 서비스 제공 업체 중 하나. 웹 호스팅, 도메인 등 록, 웹 사이트 제작 도구, SSL 인증서 등 다양한 웹 기반 서비스를 제공
 ...
 * - 이메일 호스팅: 사용자 정의 이메일 도메인을 생성하고 이메일 호스팅을 제공하여 전문적인 비즈니스 이메일 을 설정
 *
 *
 *
 *
 *
 * GoDaddy 도메인 용어 설명(godaddy1 사진)
 ...
 * - NS 레코드(Name Server Record): 특정 도메인을 관리 하는 이름 서버를 지정
 ...
 *  - Vercer > View Domains > 도메인 입력 후 Add
